...
-  [MCP-серверы](./mcp) — стандарт подключения агентов к внешним системам: что это такое и зачем нужно

-  [Скиллы и плагины](./skills-i-plaginy) — как создавать инструкции для агента и собирать их в готовые пакеты